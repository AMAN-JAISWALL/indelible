...
export class ChartDB {
  ...
  static bar1CAC = {
    ...
    series: [
      {
        name: 'High Margin',
        data: [100, 120, 150, 180, 160, 200], // Example high margin data
      },
      {
        name: 'Low Margin',
        data: [80, 60, 70, 90, 110, 95] // Example low margin data
      }
    ],
    colors: ['#0D213A', '#6EC1E4'], // Adjust colors for high and low margins
    stroke: {
      show: true,
      width: 2,
      colors: ['#ffffff'] // Stroke color for better visibility
    },
    tooltip: {
      theme: 'dark',
    ...
    xaxis: {
      categories: ['Q1', 'Q2', 'Q3', 'Q4', 'Q5', 'Q6'], // Periods for the chart
    },
    yaxis: {
      title: {
        text: 'Profit Margin ($) and Percentage'
      },
      min: 0,
  ...
  static pie1CAC = {
    ...
    labels: ['Rooms', 'Breakfasts', 'Dinners'],
    series: [60, 25, 15], // Example data: Rooms, Breakfasts, Dinners
    colors: ['#0D213A', '#6EC1E4', '#FFB64D'], // Adjust colors for different categories
    legend: {
      show: true,
      position: 'bottom',
    },
